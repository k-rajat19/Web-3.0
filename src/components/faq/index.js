    ...
    const faqData = [
        {
            ...
            answer: 'SEVEN22 PROJECT (SEVEN22) is a digital collection of 7,022 unique NFTs (non-fungibletokens) SEVEN22 PROJECT is the first invite-only community and collective of elite members who share a community-first mindset and are focused on spreading peace throughout the galaxy with community giveaways and charitable models. Poised to take over the NFT Galaxy for the greater good, the Staking and Rewards make us unique and different from any other NFT community today. Where the value of the community is reflected back to the community members. See Seven22 Project Rewards below'
        },
        {
            question: 'WHEN IS THE LAUNCH DATE ?',
            answer: 'The SEVEN22 PROJECTs will take on its first mission on August 22, 2022'
        },
        {
        ...
        },
        {
            ...
            answer: "MetaMask is a web browser extension that allows you to manage your Ethereum private keys via your web browser. By doing so, it serves as a wallet for Ether and ERC-20 tokens, and allows you to visit the distributed web of tomorrow in your browser today. To be more specific, it allows you to run Ethereum Dapps (Decentralized Apps) right in your browser without running a full Ethereum node. (In other words, you don't have to download and sync the full blockchain on your device or computer). Our mission is to make Ethereum as easy to use for as many people as possible. What is MetaMask - https://youtu.be/YVgfHZMFFFQ How to install MetaMask on all devices and browsers: https://metamask.zendesk.com/hc/en-us/articles/36001548953-Getting-started-with-Meta Mask "
        },
        {
            question: 'HOW DO I TRANSFER ETHEREUM TO MY METAMASK ACCOUNT?',
            answer: "From Coinbase and Gemini https://docs.everbloom.co/article/255jk54yda-step-three-sending-your-eth-to-your-walletM Coinbase to Metamask desktop - https://www.youtube.com/watch?v=A_j9feqBgnc Coinbase to Metamask phone - https://www.youtube.com/watch?v=UtMdutkCoQI Crypto.com to Metamask phone - https://www.youtube.com/watch?v=osqMhR6bt_Y https://www.youtube.com/watch?v=6NsX7jTvt3k Seven22 English Desktop -https://__________________________Seven22 English Mobile - https://___________________________Seven22 Spanish Desktop - https://_________________________"
        },
        {
            question: 'HOW DO I PURCHASE A SEVEN22 PROJECT NFT?',
            answer: "Watch the loom video below on how to mint your Seven22 NFT! Welcome to the SEVEN22 PROJECTs community! https://_____________________________________________"
        },
        {
            question: 'HOW MANY MINTABLE NFTS ARE THERE?',
            answer: "SEVEN22 PROJECT (Seven22) is a digital collection of 7,022 unique NFTs (non-fungible tokens) that will be minted in multiple releases. Check the roadmap for the release dates"
        },
        {
