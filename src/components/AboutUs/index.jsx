        ...
        <div className="main-container">
          <div className="text-container">
            ...
            <div className="text-para">
              The blockchain will provide an indelible record of the beginning of The Movement that will reshape wealth in minority communities.<br />
          ...
          <div className="image-container-wrapper-mobile">
            ...
            <div className="image-container-1">
              ...
              <img src="/assets/images/nft3.jpg" alt="" />
              <div className="lines">
                <div></div>
                <div></div>
              </div>
