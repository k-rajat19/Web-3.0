      ...
      <div className="navbar-inner-wrapper">
        ...
        <div className="navbar-tabs-container">
          ...
          <div className="social-icons">
            ...
            <div className="social-icon"><img src="/assets/svg/NavBar/telegram.svg" alt="" /></div>
            <div className="social-icon"><img src="/assets/svg/NavBar/instagram.svg" alt="" /></div>
            <div className="social-icon"><img src="/assets/svg/NavBar/discord.svg" alt="" /></div>

          </div>
        </div>
        <div className="list-joining-link">
          <a href="https://onemint.io/join/Seven22">Click to Join the list</a>
